...
class Release(SqlAlchemyBase):
    ...
    major = sqlalchemy.Column(sqlalchemy.BigInteger, index=True)
    minor = sqlalchemy.Column(sqlalchemy.BigInteger, index=True)
    build = sqlalchemy.Column(sqlalchemy.BigInteger, index=True)
